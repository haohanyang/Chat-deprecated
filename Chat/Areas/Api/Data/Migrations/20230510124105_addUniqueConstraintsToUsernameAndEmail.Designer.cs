...
namespace Chat.Areas.Api.Data.Migrations
{
    ...
    [Migration("20230510124105_addUniqueConstraintsToUsernameAndEmail")]
    partial class addUniqueConstraintsToUsernameAndEmail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chat.Areas.Api.Models.Membership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Chat.Areas.Api.Models.GroupMessage", b =>
                {
                    ...
                    b.HasOne("Chat.Areas.Api.Models.User", "Sender")
            ...
            modelBuilder.Entity("Chat.Areas.Api.Models.Membership", b =>
                {
                    ...
                    b.HasOne("Chat.Areas.Api.Models.User", "User")
                        .WithMany("Memberships")
            ...
            modelBuilder.Entity("Chat.Areas.Api.Models.UserMessage", b =>
                {
                    b.HasOne("Chat.Areas.Api.Models.User", "Receiver")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Chat.Areas.Api.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
